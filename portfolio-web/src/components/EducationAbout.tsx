...
const EducationData = [
  {
    uniYear: "Frenify University ( 2014 — 2017 )",
  ...
  {
    uniYear: "Tech Institute ( 2015 — 2018 )",
  ...
  {
    uniYear: "Digital College ( 2016 — 2019 )",
  ...
  {
    uniYear: "Code Academy ( 2017 — 2020 )",
...
export default function EducationAbout() {
  return (
    <div>
      ...
      <Headings headText="Education." headClass="" />
